function PlayersControllers() {
    ...
    function drawPlayTeam(players) {
        ...
        for (let i = 0; i < players.length; i++) {
            ...
            <a onclick="app.controllers.playersControllers.removeFromTeam(${player.id})" class="btn btn-primary text-white">Remove</a>
            </div>
            </div>
            </div>
            `
    ...
    function drawPlayerList(players) {
        ...
        for (let i = 0; i < players.length; i++) {
            ...
            <a onclick="app.controllers.playersControllers.addPlayer(${player.id})" class="btn btn-primary text-white">Add Player</a>
            </div>
            </div>
            </div>
            </div>
